...
def main(username,userpassword,userrole,userdatasets,admin,password,host,port,mongopath):
    ...
    user_userdetails = db_user["account"]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-b', '--datasets', nargs='+', type=str, help='Space separated list of name of datasets ids the user can access to')
