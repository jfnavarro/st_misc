...
<<<<<<< HEAD
    proc = subprocess.Popen(['/Users/netlight/mongodb-osx-x86_64-2.4.1/bin/mongoimport','--host',host,'--port',str(port),"--collection",nameExp,'--db','features','--file',features,'--upsert'], 
...
=======
    proc = subprocess.Popen([mongopath + 'mongoimport','--host',host,'--port',str(port),
                            ...
                            stdout=subprocess.PIPE, stderr=subprocess.PIPE)
>>>>>>> 949be8b1fcffc4d38a4307dc52b76b0a0323c1e8
...
<<<<<<< HEAD
    proc = subprocess.Popen(['/Users/netlight/mongodb-osx-x86_64-2.4.1/bin/mongoimport','--host',host,'--port',str(port),"--collection",nameExp,'--db','reads','--file',reads,'--upsert'], 
                            stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    (stdout, errmsg) = proc.communicate()
    print stdout
    print errmsg
