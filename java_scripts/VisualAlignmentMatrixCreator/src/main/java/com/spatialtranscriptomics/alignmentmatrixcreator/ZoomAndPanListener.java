...
public class ZoomAndPanListener implements MouseListener, MouseMotionListener, MouseWheelListener {
    public static final int DEFAULT_MIN_ZOOM_LEVEL = -2000;
    public static final int DEFAULT_MAX_ZOOM_LEVEL = 2000;
    public static final double DEFAULT_ZOOM_MULTIPLICATION_FACTOR = 1.003;
